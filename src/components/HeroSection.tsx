export default function HeroSection() {
  return (
    <section className="relative h-[75vh] min-h-[550px] w-full overflow-hidden bg-ink max-[900px]:h-[60vh] max-[900px]:min-h-[450px] max-[479px]:h-[52vh] max-[479px]:min-h-[360px]">
      ...
      <div className="relative z-[3] flex h-full flex-col items-center justify-center px-5 pb-[60px] pt-[120px] text-center max-[767px]:px-4 max-[767px]:pb-10 max-[767px]:pt-[140px]">
